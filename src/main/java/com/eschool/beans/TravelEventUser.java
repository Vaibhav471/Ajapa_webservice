...
public class TravelEventUser {
	...
	public TravelEventUser(int travelId, int eventId, int userId, String fromCity, String fromCountry, Date arrivalDate,
			String arrivalTime, String arrivalModeOfTransport, String arrivalTrainNumber, String arrivalTrainName,
			Date departureDate, String departureTime, String departureModeOfTransport, String departureTrainName,
			String description, String userName, String eventName) {
