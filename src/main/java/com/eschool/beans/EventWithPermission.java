...
public class EventWithPermission {
	...
	private int eventId;
	private String eventName,eventType,eventLocation,listedBy,startTime,endTime,adminId;
	private int eventStatus;
	private Blob other;
	Date startDate;
	public EventWithPermission(int eventId, String eventName, String eventType, String eventLocation, String listedBy,
			String startTime, String endTime, String adminId, int eventStatus, Blob other, Date startDate, Date endDate,
			Date lockArrivalDate, Date lockDepartureDate, String canModify, String canDelete) {
